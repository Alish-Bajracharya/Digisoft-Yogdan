...
const PlanCard = ({ plan }) => {
  return (
    <div className="bg-white max-w-md w-full h-full rounded-2xl shadow-md border border-gray-200 hover:shadow-xl hover:border-green-500 transition-transform transform hover:scale-[1.03] p-6 flex flex-col justify-between">
      {/* Plan Title */}
      <div>
