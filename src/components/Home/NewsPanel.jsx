    ...
    <section className="bg-[#efefef] py-10">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-6 justify-center items-stretch">
          ...
          {/* News Panel */}
          <div className="w-full lg:w-[48%] bg-white p-2  shadow-md h-full self-stretch">
            <h5 className="text-[#f7941e] font-semibold uppercase border-b border-gray-300 pb-2 mb-2 text-lg">
              Recent Posts
            </h5>
            {posts.map((post, idx) => (
              <div
                key={idx}
                className={`flex gap-4 mb-4 p-3 rounded-md hover:bg-gray-50 transition-all duration-200 ${
                  idx !== posts.length - 1 ? "border-b border-dashed" : ""
                }`}
              >
                <img
                  src={post.img}
                ...
                <div>
                  <span className="text-sm text-gray-500 block mb-1">
                    <i className="fa fa-calendar pr-1 text-[#18b162]"></i>
                    {post.date}
                  </span>
          ...
          {/* Mobile Banking Section */}
            <div className="w-full lg:w-[48%] bg-white p-6  shadow-md h-full self-stretch">

            <h5 className="text-xl font-semibold uppercase mb-6">Mobile Banking</h5>
            <h2 className="text-[#f7941e] font-bold text-3xl relative pb-4 mb-9 border-b border-gray-300">
              See What's New With Our Mobile Banking App
            </h2>
            <p className="text-gray-700 text-2xl leading-relaxed mb-9">
              Experience banking right from your phone or tablet - fast, secure, and easy to use.
            </p>
            <div>
              <h3 className="font-medium text-2xl mb-9">Download the App</h3>
              <div className="flex gap-4 flex-wrap mb-5">
                <a
                  href="#"
                  className="bg-[#333] hover:bg-black text-white px-5 py-3 flex items-center rounded-lg transition-all duration-200"
                >
